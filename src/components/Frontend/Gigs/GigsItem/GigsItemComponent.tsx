          ...
          <div className="lg:w-3/4">
            ...
            <div className="mb-8">
              <div className="relative aspect-video rounded-lg overflow-hidden shadow-lg">
                {isPlaying && gigData.url ? (
                  <div className="w-full h-full bg-black">
                    {gigData.url.includes("drive.google.com") ? (
                      <iframe
                        src={transformDriveUrl(gigData.url)}
                  ...
                  <>
                    ...
                    >
                      <div className="w-16 h-16 bg-white bg-opacity-80 rounded-full flex items-center justify-center hover:scale-110 transition-transform duration-300">
                        <svg
            ...
            <div className="mt-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6 border w-full">
                {activeTab == "overview" && (
