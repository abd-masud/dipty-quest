      ...
      <main>
        <div className="max-w-screen-xl mx-auto px-4 md:py-[50px] py-10 md:grid block grid-cols-3 gap-6 items-stretch">
          <div className="col-span-2 flex flex-col justify-between md:mb-0 mb-5">
            ...
            <div className="flex">
              <Link
                className="font-semibold bg-[#FAB616] px-5 py-2 rounded-full text-[12px] text-[#0E0C25] hover:bg-[#0E0C25] hover:text-white border-b-2 border-[#0E0C25] hover:border-[#FAB616] transition-colors duration-300 flex items-center group mt-5"
                href="/upcoming-events"
              >
                <span>See All Events</span>
                <FaArrowRight className="ml-1 -rotate-45 group-hover:rotate-0 transition-transform duration-300 text-[10px]" />
